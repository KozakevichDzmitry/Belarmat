...
Donate link: https://berocket.com/?utm_source=wordpress_org&utm_medium=donate&utm_campaign=products_of_day
...
= Plugin Links: =
[Demo](https://woocommerce-product-of-day.berocket.com/shop/?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=products_of_day)
[Demo Description](https://woocommerce-product-of-day.berocket.com/?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=products_of_day)

= &#127852; Wanna try admin side? =
[Admin Demo](https://berocket.com/product/woocommerce-products-of-day?utm_source=wordpress_org&utm_medium=admin_demo&utm_campaign=products_of_day#try-admin) - Get access to this plugin's admin and try it from inside. Change things and watch how they work.
...
* Fix - incompatibility with other BeRocket plugins
...
= 3.5.1 =
* Enhancement - Possibility to enable/disable Products of Day

= 3.5.0.2 =
* Fix - Links to BeRocket
* Fix - Compatibility with other BeRocket plugins
* Fix - Use Wordpress time instead UTC in condition
...
= 3.5 =
* Enhancement - Conditions to select where must be displayed products of the day
* Enhancement - Conditions by Week Day, Day Time, User Status, User Role, Shipping Zone, Country, Product In Cart, Page, Product Category page, Product Attribute page, Search page
* Enhancement - Up to 10 widget positions to set different products
* Enhancement - Show random products from list of products for this day		
* Enhancement - Shortcode to display products of day		
* Enhancement - Slider type of widget and shortcode		
* Enhancement - Add products before content, after content and before footer on pages
